    ...
    <form id="form1" runat="server">
        ...
        <table class="auto-style2">
            <tr>
                ...
                <td rowspan="4">
                        <asp:Label ID="errorLB" runat="server" Text="錯誤提示" CssClass="auto-style12" Font-Names="Gen Jyuu Gothic Medium" Font-Size="18pt" Visible="False" ForeColor="Red" Width="484px" Height="199px"></asp:Label>
                </td>
            </tr>
            <tr>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <tr>
                ...
                <td class="auto-style27">
                        <asp:Button ID="checkBT" BackColor="#FDE9E8" BorderColor="#DFAEB2" BorderStyle="Dotted" CssClass="auto-style12" Font-Names="Gen Jyuu Gothic Medium" runat="server" Text="確認訂購" Width="100px" BorderWidth="3px" Font-Size="16pt" ForeColor="#FA839A" OnClick="checkBT_Click" Visible="False" />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Button ID="cancelBT" BackColor="#FDE9E8" BorderColor="#DFAEB2" BorderStyle="Dotted" CssClass="auto-style12" Font-Names="Gen Jyuu Gothic Medium" runat="server" Text="取消訂購"  Width="100px" BorderWidth="3px" Font-Size="16pt" ForeColor="#FA839A" OnClick="cancelBT_Click" Visible="False"/>
                        </td>
            </tr>
            <tr>
                <td class="auto-style3">
