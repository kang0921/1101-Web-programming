        ...
        <table class="auto-style2">
            ...
            <tr>
                ...
                <td class="auto-style17">
                    <asp:Label ID="id_LB" runat="server" Font-Names="Noto Sans CJK TC Medium" Font-Size="14pt" ForeColor="#F1CD9D" Text="帳號" CssClass="auto-style22"></asp:Label>
            ...
            <tr>
                <td class="auto-style3">&nbsp;</td>
                <td class="auto-style6">
                    <asp:DetailsView ID="clientDetailsView" runat="server" AutoGenerateRows="False" DataSourceID="clientDetail" Height="50px" Width="334px" Font-Names="Gen Jyuu Gothic Medium">
                        <Fields>
